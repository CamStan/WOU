...
//
//
// Below is the syntax highlighted version of Graph.java from § Algorithms.   Here is the Javadoc. 
//
//
// 
/*************************************************************************
 ...
 * @author Kevin Wayne
 * @author Modified by Cameron Stanavige for a specific structure
 */
public class Graph {
	private final int V;
	private int E;
